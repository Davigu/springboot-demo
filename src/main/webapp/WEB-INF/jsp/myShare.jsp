    ...
    <div class="row">
        <div class=" col-md-3 text-center"> <a class="btn" href="#">
            ...
            <div class="list-group posi" >
                <a href="/allPhoto" class="list-group-item"><span class="glyphicon glyphicon-picture"></span> 全部照片</a>
                <a href="/myAlbum" class="list-group-item"><span class="glyphicon glyphicon-book"></span> 我的相册</a>
                <a href="/myShare" class="list-group-item active"><span class="glyphicon glyphicon-new-window"></span> 我的分享</a>
