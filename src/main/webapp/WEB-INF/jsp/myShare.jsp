    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content"   style="height: 570px">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <form class="form-inline">
                        ...
                        <label>照片尺寸：</label>
                        <label >普通&nbsp;
                            <input type="radio" class="radio" value="0" name="definition"></label>&nbsp;&nbsp;&nbsp;
                        <label >高清&nbsp;
                            <input type="radio" class="radio" value="0" name="definition"></label>&nbsp;&nbsp;&nbsp;
                        <label >原图&nbsp;
                            <input type="radio" class="radio" value="0" name="definition"></label>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="thumbnail">
                            <img src="images/100X125.gif" style="height: 100px;width: 100%" alt="">
                            <p>aaaa</p>
                        </div>
                    </div>
                    <div>
                        <a href="#"><img src="images/addPhoto.png" alt=""></a>
                    </div>
                </div>
            </div>
            <div class="panel-footer">
                ...
                共<label>5</label>张照片（上传过程中请不要删除原始图片）
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal">
                    <div><label for="albumName">相册名称：</label><input class="form-control" type="text" id="albumName" placeholder="相册名称">
                        <label>0</label>/30</div>
                    <div><label for="albumName">相册描述：</label><textarea class="form-control" rows="3"></textarea>
                        <label>0</label>/2000</div>
...
<div class="container">
    <div class="row">
        <div class=" col-md-3 text-center"> <a class="btn" href="#">
            ...
            <div class="list-group posi" > <a href="#" class="list-group-item"><span class="glyphicon glyphicon-picture"></span> 我的照片</a> <a href="#" class="list-group-item"><span class="glyphicon glyphicon-book"></span> 我的相册</a> <a href="#" class="list-group-item active"><span class="glyphicon glyphicon-new-window"></span> 我的分享</a> <a href="#" class="list-group-item"><span class="glyphicon glyphicon-trash"></span> 回收站</a> </div>
        </div>
